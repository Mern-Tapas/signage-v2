...
function PlaylistList({ className, detailedView = true }: { className?: string, detailedView?: boolean }) {
    ...
    return (
        <Container padding='sm' radius='xl' className={`grid grid-cols-[220px_1fr] gap-4 ${detailedView ? "lg:grid-cols-[350px_1fr_1fr_1fr_1fr]" : ""} items-center w-full ${className}`}>
            ...
            <div className='flex gap-4 items-center w-full  '>
                ...
                <div className="w-10 h-10 shrink-0 rounded-lg bg-gradient-to-br from-pink-500 via-pink-600 to-pink-700 flex items-center justify-center shadow-lg shadow-blue-300/50 hover:shadow-blue-400/60 transition-all duration-300 cursor-pointer group">
